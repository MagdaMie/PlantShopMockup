...
function App() {
  ...
  const handleRemovePlantFromTheCart = (product) => {
    setPlantsInTheCart(
      plantsInTheCart.filter(
        (plantInTheCart) => plantInTheCart.id !== product.id
      )
    );
  };
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense fallback={<div>Loading...</div>}>
              <Products products={products} addPlant={handleAddPlantTheCart} />
            </Suspense>
          }
        />
        ...
        <Route
          ...
          element={
            <Suspense fallback={<div>Loading...</div>}>
              <ProductPage addPlant={handleAddPlantTheCart} />
            </Suspense>
          }
        />
